...
* -------------------------------------------------------- * 
 * produce the partial r-squared estimates for the subset poi sample using the data aggregated at the cbg level * 
 * -------------------------------------------------------- * 
...
* share variance explained by access in Table 1
display `p_1'
display `p_2'
display `p_3'
...
* -------------------------------------------------------- * 
 * produce the partial r-squared estimates for the subset poi sample using the data aggregated at the urban level * 
 * -------------------------------------------------------- * 

import delimited "`main_path'/data/clean/outcomes_urb_clean_popweighted.csv", clear
